...
builder.Services.RegisterDataBaseDependencies(new Journal.Database.Registration.Dependencies.ContextRegistrationParams
{
...
builder.Services.RegisterJournal();
